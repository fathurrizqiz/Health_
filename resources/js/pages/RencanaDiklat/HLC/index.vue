                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    ...
                                    >
                                        ...
                                        <td class="px-4 py-3">
                                            <input
                                                v-model.number="row.total_biaya"
                                                type="number"
                                                class="w-full rounded border px-2 py-1 text-sm"
                                            />
                                        </td>
