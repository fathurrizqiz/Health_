    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-1 flex-col gap-4 p-4 md:gap-6 md:p-6">
            ...
            >
                ...
                <div
                    class="flex flex-col gap-5 border-b border-slate-100 p-5 md:p-6 lg:flex-row lg:items-center lg:justify-between dark:border-slate-800"
                >
                    <!-- Progress Info -->
                ...
                >
                    ...
                    >
                        ...
                        <h4
                            class="mb-1 leading-tight font-bold text-slate-900 dark:text-white"
                        >
                            {{ item.nama_diklat }}
                        </h4>
                ...
                >
                    ...
                    >
                        ...
                        <div class="flex justify-center gap-2">
                            <button
                                disabled
                                class="flex-1 rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-bold opacity-50 sm:flex-none dark:border-slate-700 dark:bg-slate-800"
                            >
                                Prev
                            </button>
                            <button
