...
- Name: Diklat_Karyawan\Penyelenggarakosong.spec.ts >> test
- Location: tests\Playwright\Diklat_Karyawan\Penyelenggarakosong.spec.ts:3:1
...
> 11 |   await page.getByRole('link', { name: 'Diklat', description: 'Diklat', exact: true }).click();
  ...
  13 |   await page.getByRole('textbox', { name: 'Tanggal Mulai Tanggal Selesai' }).press('ArrowLeft');
  14 |   await page.getByRole('textbox', { name: 'Tanggal Mulai Tanggal Selesai' }).fill('2026-05-22');
  15 |   await page.locator('#tanggal').nth(1).fill('2026-05-22');
  ...
  20 |   await page.getByRole('combobox', { name: 'Pengajar' }).click();
  21 |   await page.getByRole('combobox', { name: 'Pengajar' }).fill('dr Minar');
  ...
  25 |   await page.locator('#keterangan').nth(1).fill('kosongk');
  26 |   await page.locator('#keterangan').nth(2).click();
  27 |   await page.locator('#keterangan').nth(2).fill('kosong');
